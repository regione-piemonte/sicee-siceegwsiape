...
/**
 * The primary key class for the SICEE_T_ALTRE_INFO database table.
 * 
 */
@Embeddable
public class SiceeTAltreInfoPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SiceeTAltreInfoPK)) {
			return false;
		}
		SiceeTAltreInfoPK castOther = (SiceeTAltreInfoPK)other;
		return 

...
/**
 * The primary key class for the SICEE_T_DATI_XML_2015 database table.
 * 
 */
@Embeddable
public class SiceeTDatiXml2015PK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SiceeTDatiXml2015PK)) {
			return false;
		}
		SiceeTDatiXml2015PK castOther = (SiceeTDatiXml2015PK)other;
		return 
